...
with sync_playwright() as p:
    ...
    def snooze():
        ...
        expect(page.locator('[data-planning-choices]')).to_have_count(0)
        expect(page.locator('[data-planning-choices-trigger]')).to_have_count(0)
    check('today snooze hides both automatic guide and its trigger across reload',snooze,page)
    def next_open_day():
        ...
        expect(page.locator('[data-planning-choices-trigger]').filter(visible=True).first).to_be_visible()
        base['open_choices'](page)
